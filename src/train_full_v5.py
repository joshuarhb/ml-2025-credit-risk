...
from src.features_granular import process_granular_features
...
def run_full_training():
    ...
    df_gran = process_granular_features(DATA_DIR)
    ...
    df_train = df_train.merge(df_gran, on="case_id", how="left")
